...
A powerful, workflow-oriented Model Context Protocol (MCP) server for therapeutic discovery and drug repurposing. This server provides a seamless bridge between agentic platforms (like Antigravity, Claude Desktop, or Cursor) and the [Open Targets Platform](https://platform.opentargets.org/), leveraging its comprehensive GraphQL API.
...
To use this with an MCP-compatible agent, add the following to your configuration:
